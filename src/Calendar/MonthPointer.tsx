...
): number => monthPointer.currentIndex;
...
export const moveLeft = (
  ...
  currentIndex:
    monthPointer.currentIndex > 0 ?
      monthPointer.currentIndex - 1
    : 0,
  data:
    monthPointer.currentIndex > 0 ?
      monthPointer.data
    : A.prepend(
        pipe(NEA.head(monthPointer.data), (x) =>
          addMonths(x, -1),
        ),
      )(monthPointer.data),
});
...
export const moveRight = (
  ...
  data:
    (
      ...
      monthPointer.data.length - 1
    ) ?
      A.append(
        pipe(NEA.last(monthPointer.data), (x) =>
          addMonths(x, 1),
        ),
      )(monthPointer.data)
    : monthPointer.data,
